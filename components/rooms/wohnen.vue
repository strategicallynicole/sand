<template>
  <z-view style="border-width: 8px" slider :progress="progress">
    ...
    <img
      slot="image"
      src="https://raw.githubusercontent.com/zircleUI/smarthome-tutorial/228537252dfec44e1a447e31270fca3412fa1e6e/public/living.jpg"
      width="100%"
      height="100%"
      style="opacity: 0.3"
    >
              ...
              vm.devices = [
                {
                  name: "AC",
                  state: "on",
                  temp: { qty: 24, unit: "˚C", min: 18, max: 32 }
                },
                {
                  name: "TV",
                  state: "off",
              ...
              vm.devices = [
                {
                  name: "AC",
                  state: "on",
                  temp: { qty: 18, unit: "˚C", min: 18, max: 32 }
                },
                {
                  name: "TV",
                  state: "on",
              ...
              vm.devices = [
                {
                  name: "AC",
                  state: "on",
                  temp: { qty: 20, unit: "˚C", min: 18, max: 32 }
                },
                {
                  name: "TV",
                  state: "off",
